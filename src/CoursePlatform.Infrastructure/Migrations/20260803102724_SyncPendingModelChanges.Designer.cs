...
namespace CoursePlatform.Infrastructure.Migrations
{
    ...
    [Migration("20260803102724_SyncPendingModelChanges")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoursePlatform.Domain.Entities.CourseWaitlistEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CourseWaitlistEntries");
                });
            ...
            modelBuilder.Entity("CoursePlatform.Domain.Entities.GiftPurchase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CoursePlatform.Domain.Entities.LessonResource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CoursePlatform.Domain.Entities.NewsletterSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CoursePlatform.Domain.Entities.Subscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CoursePlatform.Domain.Entities.SubscriptionInvoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CoursePlatform.Domain.Entities.TrialAccess", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CourseId", "ActivatedAt");

                    b.ToTable("TrialAccesses");
                });

            modelBuilder.Entity("CoursePlatform.Domain.Entities.WishlistItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CoursePlatform.Domain.Entities.GiftPurchase", b =>
                {
                    b.HasOne("CoursePlatform.Domain.Entities.ApplicationUser", "BuyerUser")
                        .WithMany()
                    ...
                    b.HasOne("CoursePlatform.Domain.Entities.ApplicationUser", "RedeemedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("CoursePlatform.Domain.Entities.Subscription", b =>
                {
                    b.HasOne("CoursePlatform.Domain.Entities.ApplicationUser", "User")
                        ...
                        .HasForeignKey("CoursePlatform.Domain.Entities.Subscription", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("CoursePlatform.Domain.Entities.SubscriptionInvoice", b =>
                {
                    b.HasOne("CoursePlatform.Domain.Entities.Subscription", "Subscription")
                        .WithMany("Invoices")
