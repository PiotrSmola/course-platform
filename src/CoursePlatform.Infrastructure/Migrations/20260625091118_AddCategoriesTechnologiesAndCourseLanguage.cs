...
{
    /// <inheritdoc />
    public partial class AddCategoriesTechnologiesAndCourseLanguage : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseTechnology", x => new { x.CoursesId, x.TechnologiesId });
                    table.ForeignKey(
                        name: "FK_CourseTechnology_Courses_CoursesId",
                        column: x => x.CoursesId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseTechnology_Technologies_TechnologiesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseTechnology_TechnologiesId",
